...
public class QueryService {
    ...
    private static final String CONTEXT = """
            ...
            Schema:
            1) product_arcturus_22(id UUID, product_id VARCHAR, name VARCHAR, price DOUBLE, description TEXT, image VARCHAR, created TIMESTAMP)
            2) product_view_arcturus_22(id UUID, product_id VARCHAR, user_ip VARCHAR, view_count INT, last_updated TIMESTAMP)
            Join:
             - product_arcturus_22.product_id = product_view_arcturus_22.product_id
