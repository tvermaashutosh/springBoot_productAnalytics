...
### Products Table (`product_arcturus_22`)
...
### Product Views Table (`product_view_arcturus_22`)
...
```bash
curl "http://localhost:8080/api/query/execute?query=SELECT%20name,%20price%20FROM%20product_arcturus_22%20WHERE%20price%20%3C%2050"
```
